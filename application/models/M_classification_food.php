...
class M_classification_food extends CI_Model
{
    ...
    {
        $result = $this->db->query("SELECT cf.id_classification_food, cf.id_classification, cf.name, cf.weight, cf.urt, cf.kalori, cf.protein, cf.lemak, cf.karbohidrat, cf.serat, cf.natrium, cf.kalium FROM tb_classification_food AS cf WHERE cf.id_classification = '$id_classification' ORDER BY cf.updated_at DESC");
        return $result;
    }
